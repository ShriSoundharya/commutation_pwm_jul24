...
################################################################
# This is a generated script based on design: commutation_PWM_jul24
#
...
# source commutation_PWM_jul24_script.tcl
...
set design_name commutation_PWM_jul24
...
proc create_root_design { parentCell } {
  ...
  set input_1 [ create_bd_port -dir I input_1 ]
  set input_2 [ create_bd_port -dir I input_2 ]
  set input_3 [ create_bd_port -dir I input_3 ]

  # Create instance: Dead_band, and set properties
  set Dead_band [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 Dead_band ]
  ...
  # Create instance: Duty_ratio, and set properties
  set Duty_ratio [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 Duty_ratio ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {7} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {12} \
  ...
  connect_bd_net -net Dead_band_Dout [get_bd_pins Dead_band/Dout] [get_bd_pins top_module_0/band_i]
  connect_bd_net -net Duty_ratio_Dout [get_bd_pins Duty_ratio/Dout] [get_bd_pins top_module_0/duty_i]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins Dead_band/Din] [get_bd_pins Duty_ratio/Din] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net input_1_1 [get_bd_ports input_1] [get_bd_pins top_module_0/input_1]
  connect_bd_net -net input_2_1 [get_bd_ports input_2] [get_bd_pins top_module_0/input_2]
  connect_bd_net -net input_3_1 [get_bd_ports input_3] [get_bd_pins top_module_0/input_3]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins top_module_0/CLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net top_module_0_Q_1 [get_bd_ports Q_1] [get_bd_pins top_module_0/Q_1]
  connect_bd_net -net top_module_0_Q_2 [get_bd_ports Q_2] [get_bd_pins top_module_0/Q_2]
  connect_bd_net -net top_module_0_Q_3 [get_bd_ports Q_3] [get_bd_pins top_module_0/Q_3]
  connect_bd_net -net top_module_0_Q_4 [get_bd_ports Q_4] [get_bd_pins top_module_0/Q_4]
  connect_bd_net -net top_module_0_Q_5 [get_bd_ports Q_5] [get_bd_pins top_module_0/Q_5]
  connect_bd_net -net top_module_0_Q_6 [get_bd_ports Q_6] [get_bd_pins top_module_0/Q_6]
